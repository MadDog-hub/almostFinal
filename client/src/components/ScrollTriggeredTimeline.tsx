    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
                <div className="absolute top-1/4 left-1/4 w-32 h-32 border border-[#C9BAA8] rounded-full"></div>
                <div className="absolute bottom-1/4 right-1/4 w-48 h-48 border border-[#C9BAA8] rounded-full"></div>
                <div className="absolute top-1/3 right-1/3 w-24 h-24 border-2 border-[#C9BAA8] rotate-45"></div>
                <div className="absolute bottom-1/3 left-1/5 w-16 h-16 border border-[#C9BAA8] rounded-full"></div>
                <div className={`absolute top-1/2 left-1/6 w-6 h-6 bg-[#C9BAA8] rounded-full ${animationsEnabled ? 'animate-pulse' : ''}`}></div>
                <div className="absolute bottom-1/2 right-1/5 w-8 h-8 bg-[#C9BAA8] rotate-45"></div>
            </div>
            {/* Floating Elements */}
            ...
            <div className="relative z-10 text-center mb-12">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-serif italic mb-4 text-[#deae39]" data-testid="text-timeline-title">
                        Our Wedding Day
                    </h2>
