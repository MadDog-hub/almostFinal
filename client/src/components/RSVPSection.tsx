  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <div className="bg-card/30 border border-border rounded-xl p-12 shadow-soft hover-elegant">
            ...
            <div className="text-center mb-8">
              ...
              <h3 className="text-xl font-display font-semibold mb-2 text-[#23252f]">RSVP Deadline</h3>
              <p className="text-lg text-muted-foreground">October 30, 2025</p>
            </div>

            {/* RSVP Message */}
            <div className="space-y-6 mb-8">
              <p className="text-xl font-script italic leading-relaxed text-[#3D3228]" data-testid="text-rsvp-message">
                Your presence would make our day complete
              </p>
              <p className="text-xl font-script italic text-[#3D3228] leading-relaxed" data-testid="text-rsvp-details">
        ...
        >
          <p className="text-lg leading-relaxed text-[#3D3228]">
