  ...
  return (
    ...
    >
      ...
      <div className="text-center py-16 sm:py-20 px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-script italic font-black mb-6 sm:mb-8 text-[#3D3228]" data-testid="text-story-title">
            Our Story
          </h2>
          <p className="text-base sm:text-lg max-w-2xl mx-auto mb-4 text-[#3D3228]">
          ...
          <div className="flex items-center justify-center space-x-4 mt-6 sm:mt-8">
            ...
            <span className="text-xs sm:text-sm text-[#3D3228]">Scroll down</span>
            ...
            >
              ...
              >
                ...
                <div className={`space-y-6 sm:space-y-8 ${index % 2 === 1 ? 'lg:order-2' : ''}`}>
                  <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full mb-4 sm:mb-6 bg-[#3D3228]">
                    <span className="font-bold text-lg sm:text-xl md:text-2xl text-[#F0E6D8]">{card.id}</span>
                  </div>
                  
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-script italic mb-4 sm:mb-6 text-[#3D3228]" data-testid={`text-story-card-${card.id}-title`}>
                    {card.title}
                  </h3>
                  
                  <p className="text-lg sm:text-xl leading-relaxed text-[#3D3228]" data-testid={`text-story-card-${card.id}-text`}>
                    {card.text}
                  </p>
          ...
          <div className="story-card flex-shrink-0 w-screen h-full flex items-center justify-center px-4 sm:px-8 py-8 sm:py-12">
            <div className="max-w-4xl mx-auto text-center relative">
              ...
              <div className="relative z-10 space-y-6 sm:space-y-8">
                <h3 className="text-4xl sm:text-5xl md:text-6xl font-script italic font-black mb-6 sm:mb-8 text-[#23252f]" data-testid="text-story-vow-title">
                  Our Promise
                </h3>
                
                <div className="max-w-2xl mx-auto">
                  <p className="text-xl sm:text-2xl leading-relaxed italic mb-4 text-[#23252f]">
                    "Above all, clothe yourselves with love, which binds us all together in perfect harmony."
                  </p>
                  <p className="text-base sm:text-lg font-body text-[#23252f]">
                    Colossians 3:14
                  </p>
                </div>
