  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-0 left-0 w-96 h-96 border border-[#C9BAA8] rounded-full transform -translate-x-1/3 -translate-y-1/3"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 border border-[#C9BAA8] rounded-full transform translate-x-1/3 translate-y-1/3"></div>
      </div>
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl font-script italic max-w-2xl mx-auto leading-relaxed text-[#23252f]">
