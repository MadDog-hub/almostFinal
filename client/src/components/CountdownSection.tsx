...
const CountdownSection = () => {
  ...
  useEffect(() => {
    const targetDate = new Date('November 8, 2025 13:00:00').getTime();
  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <h2 className="text-4xl font-display text-[#3D3228] mb-2" data-testid="text-countdown-title">
            Forever starts soon
          </h2>
        </motion.div>
        ...
        >
          {[
            ...
            >
              <motion.div 
                className="text-3xl md:text-4xl font-display mb-1 text-[#3D3228]"
                key={item.value}
              ...
              <div className="text-xs font-body uppercase tracking-wider text-[#6B5D51]">
                {item.label}
              </div>
            </motion.div>
          ))}
