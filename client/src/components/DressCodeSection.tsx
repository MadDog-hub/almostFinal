...
import semiformalImage from "@assets/guests_1759425882811.png";
import formalImage from "@assets/ninong&ninang_1759425882811.png";

const DressCodeSection = () => {
  const dressCodeColors = [
    { name: 'Deep Navy', color: '#05102d', hex: '#05102d' },
    { name: 'Navy Blue', color: '#1a2444', hex: '#1a2444' },
    { name: 'Antique Gold', color: '#a7752b', hex: '#a7752b' },
    { name: 'Warm Gold', color: '#b89343', hex: '#b89343' },
    { name: 'Champagne', color: '#dfcda7', hex: '#dfcda7' }
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-1/3 left-1/4 w-64 h-64 border border-[#C9BAA8] rounded-full"></div>
        <div className="absolute bottom-1/3 right-1/4 w-48 h-48 border border-[#C9BAA8] rounded-full"></div>
      </div>
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          {/* Decorative Elements */}
          <div className="absolute top-0 left-1/4 w-8 h-8 border-2 border-[#C9BAA8]/30 rounded-full"></div>
          <div className="absolute top-4 right-1/4 w-4 h-4 bg-[#C9BAA8]/20 rounded-full"></div>
          <div className="absolute bottom-0 left-1/3 w-6 h-6 border border-[#C9BAA8]/40 rounded-full"></div>
          <div className="absolute bottom-2 right-1/3 w-3 h-3 bg-[#C9BAA8]/30 rounded-full"></div>

          <h2 className="font-display italic text-gold mb-8 text-[48px]" data-testid="text-dresscode-title">
            Attire Guide
          </h2>
          <div className="bg-[#C9BAA8]/10 border border-[#C9BAA8]/20 rounded-xl p-6 max-w-2xl mx-auto relative">
            <div className="space-y-4">
              ...
              <div className="border-t border-[#C9BAA8]/30 pt-4">
                <p className="text-lg font-display font-semibold text-foreground mb-2">
                  Guests
                </p>
                <p className="text-base text-foreground">
